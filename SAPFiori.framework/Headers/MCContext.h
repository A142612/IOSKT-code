...
void MCContextGenerateComparisonInfo(MCContextRef context, MCValueInfo* value, MCValueInfo* target);
 ...
 */
bool MCContextGetNouveauSeriesColorationEnabled(MCContextRef context);
void MCContextSetNouveauSeriesColorationEnabled(MCContextRef context, bool value);

//----------------------------------
// deselectedSeriesAlpha
//----------------------------------
MCFloat MCContextGetDeselectedSeriesAlpha(MCContextRef context);
void MCContextSetDeselectedSeriesAlpha(MCContextRef context, MCFloat value);

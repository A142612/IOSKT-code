...
#import "MCSelectionTouchTarget.h"
...
@property (nonatomic, readwrite) MCSelectionTouchTarget touchTarget;
...
/*
 ...
 Always invoke super.
 */
- (void)update:(MCEvents)events;


#pragma mark Responsiveness / Behaviours

- (BOOL)respondsToEvents:(MCEvents)events;
...
@property (nonatomic, readwrite, strong) MCSelection *selection;
@end

...
#include "MCSelectionInfo.h"
#include "MCSelectionTouchTarget.h"
...
struct MCColorClosure {
    void* (*colorCallback) (MCSelectionTouchTarget touchTarget, void *info);
    void *info;
};
...
//----------------------------------
// nouveauSeriesColorationEnabled
//----------------------------------
/*
 New coloration logic:
 - If any series is selected then transparency will be applied to all deselected series (as usual).
 - If a selected series, has one or more selected values then transparency will also be applied to the selected series.
 */
bool MCGetNouveauSeriesColorationEnabled(MCRenderContextRef context);
void MCSetNouveauSeriesColorationEnabled(MCRenderContextRef context, bool value);

//----------------------------------
// deselectedSeriesAlpha
//----------------------------------
MCFloat MCGetDeselectedSeriesAlpha(MCRenderContextRef context);
void MCSetDeselectedSeriesAlpha(MCRenderContextRef context, MCFloat value);
